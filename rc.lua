...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "Next",  function () awful.client.moveresize( 0, 0, 10, 0) end),
    awful.key({ modkey }, "Prior", function () awful.client.moveresize( 0, 0, 10, 0) end),
...
client.connect_signal("manage", function (c, startup)
    ...
    if not startup then
        ...
        -- always fit windows on the screen and don't overlap
